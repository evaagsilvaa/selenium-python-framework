...
class Util(object):
    ...
    def getUniqueNameList(self, listSize=5, itemLength = None):
        ...
        Parameters:
             ...
             itemLength: It should be a list containing number of items equal to the list
             This determines the length of each item in the list [1,4,6,10]
        """
        nameList = []
        for i in range(0, listSize):
            nameList = nameList.append(self.getUniqueName(itemLength[i]))
        return nameList
